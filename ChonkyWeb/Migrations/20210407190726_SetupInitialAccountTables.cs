...
{
    public partial class SetupInitialAccountTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscordNameIdentifier = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscordUserId",
                table: "Accounts",
                unique: true,
                column: "DiscordUserId");
            migrationBuilder.CreateIndex(
                name: "IX_StripeCustomerId",
                table: "Accounts",
                unique: true,
